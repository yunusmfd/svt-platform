...
const STRINGS = {
  ...
  toc_content: { ar: "الدرس", fr: "Le cours" },
  ...
  block_content: { ar: "محتوى الدرس", fr: "Contenu du cours" },
  block_intro: { ar: "مقدّمة ومفاهيم أساسية", fr: "Introduction et notions clés" },
  lesson_loading: { ar: "…جارٍ تحميل الدرس", fr: "Chargement du cours…" },
  lesson_missing: { ar: "تعذّر تحميل هذا الدرس.", fr: "Impossible de charger ce cours." },
  crumb_prev: { ar: "الدرس السابق", fr: "Cours précédent" },
  crumb_next: { ar: "الدرس التالي", fr: "Cours suivant" },
